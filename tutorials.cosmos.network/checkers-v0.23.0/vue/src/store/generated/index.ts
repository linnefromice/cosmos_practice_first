...
import TutorialsCosmosNetworkCheckersTutorialsCosmosNetworkCheckersCheckers from './tutorials.cosmos.network/checkers/tutorials.cosmos.network.checkers.checkers'
...
export default { 
  ...
  TutorialsCosmosNetworkCheckersTutorialsCosmosNetworkCheckersCheckers: load(TutorialsCosmosNetworkCheckersTutorialsCosmosNetworkCheckersCheckers, 'tutorials.cosmos.network.checkers.checkers'),
