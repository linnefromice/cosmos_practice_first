...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		exchangesmodule.AppModuleBasic{},
	...
	maccPerms = map[string][]string{
		...
		exchangesmoduletypes.ModuleName: {authtypes.Minter, authtypes.Burner},
...
type App struct {
	*baseapp.BaseApp
	...
	ExchangesKeeper exchangesmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.ExchangesKeeper = *exchangesmodulekeeper.NewKeeper(
		appCodec,
	...
	app.mm.SetOrderBeginBlockers(
		...
		exchangesmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(exchangesmoduletypes.ModuleName)
